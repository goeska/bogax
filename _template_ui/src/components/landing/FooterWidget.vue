        ...
        <div class="grid grid-cols-12 gap-4 lg:gap-0 lg:grid-nogutter pb-12">
            <div class="col-span-12 lg:col-span-3">
                <div class="w-full text-white flex flex-col gap-4">
                    <h1 class="m-0 font-medium text-sm text-surface-500">CONTACT US</h1>
                    ...
                    <span class="text-base lg:text-sm"> 2025</span>
                </div>
            </div>
            <div class="col-span-12 lg:col-span-3">
                <div class="w-full text-white flex flex-col gap-4 py-4">
                    <h1 class="m-0 font-medium text-sm text-surface-500">ABOUT US</h1>
            ...
            <div class="col-span-12 lg:col-span-3">
                <div class="w-full text-white flex flex-col gap-4 py-4">
                    <h1 class="m-0 font-medium text-sm text-surface-500">SITE MAP</h1>
            ...
            <div class="col-span-12 lg:col-span-3">
                <div class="w-full text-white flex flex-col gap-4 py-4">
                    <h1 class="m-0 font-medium text-sm text-surface-500">CALENDAR</h1>
