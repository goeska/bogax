...
<template>
    <div id="features" class="pt-8" style="background-color: #000">
        ...
        <div class="flex flex-col items-center">
            <div class="grid grid-cols-12 gap-4 pt-12 p-6" style="max-width: 1200px">
                <div class="col-span-6 lg:col-span-4">
                    <div @mouseenter="handleMouseEnter" @mouseleave="handleMouseLeave" class="flex justify-center flex-col gap-4 border border-surface-50 dark:border-surface-800 rounded-2xl p-8 cursor-pointer h-full">
                ...
                <div class="col-span-6 lg:col-span-4">
                    <div @mouseenter="handleMouseEnter" @mouseleave="handleMouseLeave" class="flex justify-center flex-col gap-4 border border-surface-50 dark:border-surface-800 rounded-2xl text-white p-8 cursor-pointer h-full">
