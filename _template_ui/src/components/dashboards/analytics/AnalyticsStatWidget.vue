    ...
    <div v-for="stat in stats" :key="stat.label" class="col-span-12 md:col-span-4">
        <div class="card">
            <div class="flex justify-between items-center p-4">
                <div>
                    <i :class="[stat.icon, stat.iconClass, 'text-6xl!']"></i>
                </div>
            ...
            <div class="border-t border-surface flex justify-between mt-4">
                <div class="w-6/12 text-center p-4 flex flex-col border-r border-surface">
                    ...
                    <ProgressBar :value="stat.target.progress" :showValue="false"></ProgressBar>
                </div>
                <div class="w-6/12 text-center p-4 flex flex-col">
                    ...
                    <ProgressBar :value="stat.record.progress" :showValue="false"></ProgressBar>
                </div>
            </div>
        </div>
    </div>
