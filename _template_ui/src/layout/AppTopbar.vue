            ...
            [
                {
                    label: 'UTILITIES 1',
                    items: [
                        { label: 'Buy Now', icon: 'pi pi-fw pi-shopping-cart', url: 'https://www.primefaces.org/store', target: '_blank' },
                        { label: 'Documentation', icon: 'pi pi-fw pi-info-circle', to: '/start/documentation' }
                    ]
                }
            ]
        ]
    ...
    <div class="layout-topbar">
        ...
        <div class="layout-topbar-end">
            <div class="layout-topbar-actions-start">
                <MegaMenu :model="item" class="layout-megamenu" breakpoint="0px"></MegaMenu>
            </div>
            <div class="layout-topbar-actions-end">
                <ul class="layout-topbar-items">
                    <li class="layout-topbar-search">
                        ...
                        <div class="layout-search-panel hidden!">
                            <i class="pi pi-search"></i>
                            <InputText ref="searchInput" placeholder="Search" />
                            <Button type="button" icon="pi pi-times" rounded text plain v-styleclass="{ selector: '.layout-search-panel', leaveToClass: 'hidden!', leaveActiveClass: 'animate-fadeout' }"></Button>
                        </div>
                    </li>
                    <li>
                    ...
                    <li>
                        <a v-styleclass="{ selector: '@next', enterFromClass: 'hidden', enterActiveClass: 'p-anchored-overlay-enter-active', leaveToClass: 'hidden', leaveActiveClass: 'p-anchored-overlay-leave-active', hideOnOutsideClick: true }">
                            ...
                            <div class="flex flex-wrap">
                                ...
                                <div class="w-4/12 flex flex-col items-center p-4">
                                    <Button
                                        ...
                                        icon="pi pi-dollar"
                                        :pt="{
                                            icon: 'dark:text-black'
                                        }"
                                    ></Button>
                                    <span>Balance</span>
                                </div>
                                <div class="w-4/12 flex flex-col items-center p-4">
                                    <Button class="mb-2" severity="warn" rounded icon="pi pi-cog"></Button>
                                    <span>Settings</span>
                                </div>
                                <div class="w-4/12 flex flex-col items-center p-4">
                    ...
                    <li>
                        ...
                        <div class="hidden">
                            <ul class="list-none p-0 m-0">
                                <li>
                                    <a class="cursor-pointer flex items-center hover:bg-emphasis duration-150 transition-all px-4 py-2">
                    ...
                    <li>
                        <a @click="layoutState.rightMenuActive = true">
