    ...
    <Fluid class="flex flex-col md:flex-row gap-8">
        <div class="md:w-1/2">
            <div class="card flex flex-col gap-4">
                ...
                <IftaLabel>
                    <InputText id="username2" v-model="iftaValue" />
                    <label for="username2">Username</label>
                </IftaLabel>

                <div class="font-semibold text-xl">Textarea</div>
                <Textarea placeholder="Your Message" autoResize rows="3" cols="30" />

                <div class="font-semibold text-xl">AutoComplete</div>
                <AutoComplete v-model="selectedAutoValue" :suggestions="autoFilteredValue" optionLabel="name" placeholder="Search" multiple display="chip" @complete="searchCountry($event)" />

                <div class="font-semibold text-xl">DatePicker</div>
                <DatePicker showButtonBar v-model="calendarValue"></DatePicker>
        ...
        <div class="md:w-1/2">
            ...
            <div class="card flex flex-col gap-4">
                ...
                <Listbox v-model="listboxValue" :options="listboxValues" optionLabel="name" filter />
    ...
    <Fluid class="flex mt-8">
        <div class="card flex flex-col gap-4 w-full">
            ...
            <div class="flex flex-col md:flex-row gap-4">
                ...
                <InputGroup>
                    <InputGroupAddon>
                        <Checkbox v-model="inputGroupValue" binary />
                    </InputGroupAddon>
