        ...
        <div class="self-stretch p-4 sm:p-6 xl:p-8 flex flex-col items-end gap-6">
            <div class="self-stretch flex flex-col md:flex-row items-start gap-4 md:gap-8">
                ...
                <div class="flex-1 w-full flex flex-col gap-2">
                    <Dropdown v-model="formState.country" :options="countryOptions" placeholder="" class="w-full" />
                </div>
            </div>
            ...
            <div class="self-stretch flex flex-col md:flex-row items-start gap-4 md:gap-8">
                ...
                <div class="flex-1 w-full flex flex-col gap-2">
                    <InputText v-model="formState.city" placeholder="" class="w-full" />
                </div>
            </div>
            ...
            <div class="self-stretch flex flex-col md:flex-row items-start gap-4 md:gap-8">
                ...
                <div class="flex-1 w-full flex flex-col gap-2">
                    <InputText v-model="formState.region" placeholder="" class="w-full" />
                </div>
            </div>
