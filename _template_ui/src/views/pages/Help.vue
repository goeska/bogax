        ...
        <div class="card">
            ...
            <div class="grid grid-cols-12 gap-12 mb-8">
                <div class="col-span-12 md:col-span-6 lg:col-span-4">
                    <div class="flex flex-col items-center">
                        <span class="inline-flex items-center justify-center rounded-full w-20 h-20 bg-primary-100 mb-8">
                            <i class="pi pi-power-off text-3xl! text-primary-700"></i>
                        </span>
                ...
                <div class="col-span-12 md:col-span-6 lg:col-span-4">
                    <div class="flex flex-col items-center">
                        <span class="inline-flex items-center justify-center rounded-full w-20 h-20 bg-primary-100 mb-8">
                            <i class="pi pi-arrows-h text-3xl! text-primary-700"></i>
                        </span>
                ...
                <div class="col-span-12 md:col-span-6 lg:col-span-4">
                    <div class="flex flex-col items-center">
                        <span class="inline-flex items-center justify-center rounded-full w-20 h-20 bg-primary-100 mb-8">
                            <i class="pi pi-user text-3xl! text-primary-700"></i>
                        </span>
                ...
                <div class="col-span-12 md:col-span-6 lg:col-span-4">
                    <div class="flex flex-col items-center">
                        <span class="inline-flex items-center justify-center rounded-full w-20 h-20 bg-primary-100 mb-8">
                            <i class="pi pi-money-bill text-3xl! text-primary-700"></i>
                        </span>
                ...
                <div class="col-span-12 md:col-span-6 lg:col-span-4">
                    <div class="flex flex-col items-center">
                        <span class="inline-flex items-center justify-center rounded-full w-20 h-20 bg-primary-100 mb-8">
                            <i class="pi pi-database text-3xl! text-primary-700"></i>
                        </span>
                ...
                <div class="col-span-12 md:col-span-6 lg:col-span-4">
                    <div class="flex flex-col items-center">
                        <span class="inline-flex items-center justify-center rounded-full w-20 h-20 bg-primary-100 mb-8">
                            <i class="pi pi-lock text-3xl! text-primary-700"></i>
                        </span>
