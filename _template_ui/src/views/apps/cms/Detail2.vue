    ...
    <div class="p-6 card">
        <div class="grid grid-cols-12 gap-6 xl:gap-11">
            ...
            <div class="hidden xl:block xl:col-span-4 relative">
                <div class="sticky top-24 max-h-[calc(100vh-3rem)]">
                    <div class="w-full pl-6 flex flex-col">
                        ...
                        <div class="space-y-0 relative">
                            <div class="absolute left-4 top-[-20px] w-px bg-surface-200 dark:bg-surface-700" :style="{ height: `${sections.length * 44}px` }"></div>
                            ...
                            <div class="absolute left-4 w-2 h-2 rounded-full bg-surface-200 dark:bg-surface-700 -translate-x-[3px] z-10" :style="{ top: `${sections.length * 44 - 22}px` }"></div>
